...
#
# Generated by export_simulation on Mon Oct 17 18:34:43 +0300 2022
#
################################################################################
...
'-reset_run' switch to the './TestCHIConverter.sh' script.

./TestCHIConverter.sh -reset_run
...
./TestCHIConverter.sh -noclean_files

For more information on the script, please type './TestCHIConverter.sh -help'.
